...
public class PasswordUtils {
    ...
    private static final String ALPHABET = "0123456789ABCDFG"; // això hauria de ser més complet
    ...
    public static boolean verifyUserPassword(String passwordEntered, String userSalt, String securePassword) throws NoSuchAlgorithmException {
